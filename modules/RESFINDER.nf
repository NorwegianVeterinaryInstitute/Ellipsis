process RESFINDER {
        ...
        """
        python /cluster/projects/nn9305k/src/resfinder_ellipsis/resfinder.py -i $fasta -o . -x -p $params.resfinder_db -mp /cluster/software/BLAST+/2.8.1-foss-2018b/bin/blastn &> resfinder.log
